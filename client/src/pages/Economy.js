    ...
    <section className="pageSection">
      <div className="pageBreadCrumb">
        <nav>
          ...
          <Link to="/page"
            className={location.pathname === "/economy" ? "breadcrumb-active" : "breadcrumb-not-active"}
          >
            Economy
          </Link>
        </nav>
      ...
      <div className="pageSectionText">
        <p>Economy is defined as all nationals present in, or temporarily absent from a country, and aliens
